  ...
  return (
    <div className="min-h-screen bg-[#02040a] flex flex-col items-center justify-center p-6 text-white selection:bg-blue-500/30 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-gray-400 text-center mb-8">Log in to your FocusFlow account</p>
        ...
        <p className="text-center text-gray-400 mt-8">
          Don't have an account? <Link to="/signup" className="text-white font-medium hover:text-blue-400 transition-colors">Sign up</Link>
        </p>
      </motion.div>
    </div>
  );
